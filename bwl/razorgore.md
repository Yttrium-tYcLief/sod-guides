...
Whomever is mind controlling Razorgore when he breaks the last egg will begin phase 2 with a massive threat lead on the boss. **It's important to ensure that the final egg is broken by the main tank**, regardless of whomever broke the first 29 eggs, because Razorgore is taunt immune and you'll need to rely on this inherited threat.
...
As an actual boss, Razorgore's only real mechanics are an AoE fireball volley (which can be easily outhealed), and [**Conflagration**](https://www.wowhead.com/classic/spell=23023/conflagration). Conflag is casted on the player with the most threat, so all tanks should be building threat and ready to pick up as needed.
