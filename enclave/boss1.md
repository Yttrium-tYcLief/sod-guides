...
Players will occasionally receive [Carrion Swarm](https://www.wowhead.com/classic/spell=1234584/carrion-swarm) debuff. This mechanic comes in two parts - spreaders, and victims. The spreader debuff lasts for 20 seconds and does not damage the source player. However, if there are players within 5 yards of a spreader, they will receive the victim debuff, which only lasts a few seconds but deals 300 damage per second to them. As long as they stay within range of a spreader, the victim debuff will continuously refresh, though if they make enough room that it no longer refreshes, it'll fall off quickly. The victim debuff also stacks - if a victim is within range of 2 spreaders, they'll take 600 damage per second.

Spreaders will not take damage from their own spreader debuff, but they can be victims to another spreader.

Lightly spread to reduce stacks and take less damage. Alternatively, just have spreader players stand out entirely.

[Prey on the Weak](https://www.wowhead.com/classic/spell=1231342/prey-on-the-weak) will cause any players who are not within ~6 yards of another player to be attacked by mirror images of Balnazzar. This behaves sort of like the Hakkar HM Panther attack. When not victim to a Carrion Swarm, players should stick to a buddy system for Phase 1. This is less punishing in phases 2 and 3 due to mechanics in those phases encouraging clustering.
...
During Phase 2, tanks and melee should pick up adds and fight them away from the holy zones. Ranged and healers should divide amongst the holy zones. Ranged should be focusing the boss, though help on adds if they get out of control.
