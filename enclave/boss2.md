...
{% tabs classcalls %}
  ...
  {% tab classcalls#Puck %}
    ...
    <video width="100%" muted loop autoplay>
    <source src="{{site.url}}/enclave/v/boss2_puck.mp4" type="video/mp4">
    Your browser does not support the video tag.
    </video>
  ...
  {% tab classcalls#Stein %}
    ...
    <video width="100%" muted loop autoplay>
    <source src="{{site.url}}/enclave/v/boss2_stein.mp4" type="video/mp4">
    Your browser does not support the video tag.
    </video>
  ...
  {% tab classcalls#Hilda %}
    ...
    <video width="100%" muted loop autoplay>
    <source src="{{site.url}}/enclave/v/boss2_hilda.mp4" type="video/mp4">
    Your browser does not support the video tag.
    </video>
  ...
  {% tab classcalls#Fratley %}
    ...
    <video width="100%" muted loop autoplay>
    <source src="{{site.url}}/enclave/v/boss2_fratley.mp4" type="video/mp4">
    Your browser does not support the video tag.
    </video>
  ...
  {% tab classcalls#Lind %}
    ...
    <video width="100%" muted loop autoplay>
    <source src="{{site.url}}/enclave/v/boss2_lind.mp4" type="video/mp4">
    Your browser does not support the video tag.
    </video>
