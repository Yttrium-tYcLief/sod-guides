...
{: .new .fs-5}
The empowered leaders for 5/13 - 5/19 are **Stiltz** and **Puck**.
...
* Whichever 2 you fight last will simply flee to join the boss encounter when fought, just like the empowered ones.

{: .note .fs-3}
> Which two leaders are empowered will be random each week, but consistent across all raids for that week, similar to BWL's weekly affix. This means that each week, you will be forced to have two specific leaders in the fight, but which two out of four of the remaining leaders are in the fight is up to you.
>
> You can think of it like a pick/ban system. Blizzard picks 2 each week, and then in your instance you can ban 2. Blizzard then picks the remaining 2.
...
{: .highlight .fs-3}
An enemy named Cardinal Martell seems to exist within the Town Hall, but killing him does nothing and the Town Hall does not burn like the other 6 buildings/areas.
...
In Scarlet Enclave, you gain access to a checkpoint system, allowing you to fly to certain checkpoints as you unlock them using the Flight Master near the entrance to the raid.

When you kill Balnazzar and get teleported to the Prison, you'll automatically unlock that as your first checkpoint. Additional checkpoints can be unlocked by climbing the Watch Towers and lighting the Bonfires located at the top of them.

When you light the Bonfire atop the Southern Watch Tower (the one located in New Avalon), it will outright replace the Prison checkpoint. Other checkpoints are additive.

{: .note .fs-3}
When the instance soft resets (for instance, if you go in to raid on a second day) these checkpoints will not persist. You'll need to fly to the Prison and activate the Bonfires again.