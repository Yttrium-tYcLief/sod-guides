...
Solistrasza has a 10 minute berserk timer, which should be very easy to hit for any group.
...
Solistrasza is a Proto-Drake boss, not a Dragon, so she doesn't have a tail whip.

### [Tarnished Breath](https://www.wowhead.com/classic/spell=1231993)
Instead of being a traditional conal breath, this is a single-target debuff that gets applied to the tank. <ins>Tanks should swap when this goes out</ins>.

### [Cremation](https://www.wowhead.com/classic/spell=1228044)
She'll launch this at random ranged players, appearing as a yellow sphere that lands on the ground where they were standing when it was cast. When it impacts, it will blanket an area in fire. Avoid at all costs. This fire is not permanent and will subside after awhile. During Phase 1, Cremation only targets a single player. **This is the only mechanic that changes over time.** During Phase 2, she will target 3 players for Cremation, and during Phase 3, she'll target 5 players.

{: .tip .fs-3}
To best mitigate Cremation, you should have all ranged players stack and move as a group each time it goes out. In the later phases when there are 3 or 5 targets, this will ensure they all land on top of one another, reducing the battlefield chaos.

### [Crimson Flare](https://www.wowhead.com/classic/spell=1232032)
This is a bomb; the targeted player must run out of the raid ASAP. After a short period the circle will stop following the player, who should then quickly flee. Solistrasza will begin shooting a beam of plasma towards this area. The line from the boss to the targeted area will become temporarily doused in plasma, but <ins>the bomb's target area will be permanently covered in plasma</ins> which [deals 2000 damage per second](https://www.wowhead.com/classic/spell=1232097) to players within it. Try to place these bombs against the outer walls of the arena so that half of their area is out of bounds anyway. A badly placed Crimson Flare could easily ruin a fight. *This is like Green Trial from BWL mixed with Baron Geddon's Heat 3 Living Bombs.*

{: .tip .fs-3}
This will typically be cast on the closest player to her. <ins>This does not put a debuff on your bars</ins>. Because there's no debuff, DBM/Fojji/BigWigs cannot determine who the target is - you must move left/right to determine if the bomb is on you versus someone else.

### [Lightgorged Whelps](https://www.wowhead.com/classic/npc=243139)
...
### [Hallowed Dive](https://www.wowhead.com/classic/spell=1227696)
Solistrasza will fly up into the air, knocking back nearby players. After a few seconds she will slam back into the ground, damaging and stunning players in the impact zone. This is often timed around her spawning Lightgorged Whelps but these abilities are not dependent on one another.

### [Radiant Light](https://www.wowhead.com/classic/spell=1227574)
This looks like rain falling from the sky. It impacts the ground with a Holy Nova and harms nearby players. This doesn't do much damage on its own, but can contribute to the rest of the raid damage going out. Simply avoid them if possible.